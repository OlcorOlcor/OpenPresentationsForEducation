...
const SelectContainer: React.FC<SelectContainerProps> = ({
    ...
    const [warningMessageOpen, setWarningMessageOpen] =
    ...
    function isSlideCorrect(): boolean {
        if (
            slideAnalysis.words != null &&
            constraints.words != null &&
            slideAnalysis.words > constraints.words
        ) {
            return false;
        }
        if (
            slideAnalysis.characters != null &&
            constraints.characters != null &&
            slideAnalysis.characters > constraints.characters
        ) {
            return false;
        }
        if (
            slideAnalysis.images != null &&
        ...
        if (
            slideAnalysis.links != null &&
            constraints.links != null &&
            slideAnalysis.links > constraints.links
        ) {
            return false;
        }
        if (
            slideAnalysis.headings != null &&
            constraints.headings != null &&
            slideAnalysis.headings > constraints.headings
        ) {
            return false;
        }
        if (
            slideAnalysis.bullet_points != null &&
            constraints.bullet_points != null &&
    ...
    function handleDragEnd(event: DragEndEvent) {
        ...
        const oldIndex = Number(
            event.active.id.toString().replace("slide-", ""),
        );
    ...
    return (
        <Grid container spacing={1} style={{ marginBottom: "3%" }}>
            <Grid item xs>
                ...
                >
                    <SortableContext
                        items={elements.map((_, idx) => `slide-${idx}`)}
            ...
            <Grid item>
                <ButtonGroup>
                    <Tooltip
                        ...
                        title="Constraint reached!"
                        arrow
                    >
                        <Button
                            onClick={handleInfoClick}
                            ref={iconRef}
                            color={isSlideCorrect() ? "primary" : "warning"}
                        >
                            <InfoIcon
                                color={isSlideCorrect() ? "primary" : "warning"}
                            />
                    ...
                    <Tooltip
                        title={
                            elements[selectedSlideIndex] == null ||
                            !elements[selectedSlideIndex]!.isActive()
                                ? "Activate slide"
                                : "Deactivate slide"
                        }
                        arrow
                ...
                >
                    <Grid container direction="column">
                        <Grid item>
                            ...
                            Words: {slideAnalysis.words}
                        </Grid>
                        <Grid item>
                            {slideAnalysis.characters != null &&
                                constraints.characters != null &&
                                slideAnalysis.characters >
                                    constraints.characters && (
                                    <WarningIcon color="warning" />
                                )}
                            Characters: {slideAnalysis.characters}
                        </Grid>
                        <Grid item>
                            {slideAnalysis.images != null &&
                                constraints.images != null &&
                        ...
                        <Grid item>
                            ...
                            Links: {slideAnalysis.links}
                        </Grid>
                        <Grid item>
                            {slideAnalysis.headings != null &&
                                constraints.headings != null &&
                                slideAnalysis.headings >
                                    constraints.headings && (
                                    <WarningIcon color="warning" />
                                )}
                            Headings: {slideAnalysis.headings}
                        </Grid>
                        <Grid item>
                            {slideAnalysis.bullet_points != null &&
                                constraints.bullet_points != null &&
                                slideAnalysis.bullet_points >
                                    constraints.bullet_points && (
                                    <WarningIcon color="warning" />
                                )}
                            Bullet points: {slideAnalysis.bullet_points}
                        </Grid>
                        <Grid item>
                            {slideAnalysis.tables != null &&
                                constraints.tables != null &&
                                slideAnalysis.tables > constraints.tables && (
                                    <WarningIcon color="warning" />
                                )}
                            Tables: {slideAnalysis.tables}
                        </Grid>
                    </Grid>
                </Popover>
            </Grid>
