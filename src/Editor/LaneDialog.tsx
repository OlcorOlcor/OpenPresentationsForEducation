...
const LaneDialog: React.FC<LaneEditDialogProps> = ({
    lanes,
    dialogOpen,
    setDialogOpen,
    setLanes,
    ...
    useEffect(() => {
        if (
            lanes[selectedLaneIndex] !== undefined &&
            lanes[selectedLaneIndex] !== null
        ) {
    ...
    function editCurrentLane() {
        setLanes((prev) => {
            ...
            let newLane = new Lane(
                newLanes[selectedLaneIndex].getContent(),
                name,
            );
                ...
                <Grid item xs={4}>
                    <List sx={{ pt: 0 }}>
                        ...
                        <ListItem disablePadding>
                            <ListItemButton autoFocus onClick={() => addLane()}>
                                <ListItemAvatar>
                                    <Avatar>
                                        <Add />
                                    </Avatar>
