...
const AppMenu: React.FC<AppMenuProps> = ({
    ...
    const [metadataDialogOpen, setMetadataDialogOpen] =
        useState<boolean>(false);
    const [constraintsDialogOpen, setConstraintsDialogOpen] =
        useState<boolean>(false);
    const [lanesDialogOpen, setLanesDialogOpen] = useState<boolean>(false);
    const [imageDialogOpen, setImageDialogOpen] = useState<boolean>(false);
    const [styleURLDialogOpen, setStyleURLDialogOpen] =
        useState<boolean>(false);
    const [customExportOpen, setCustomExportOpen] = useState(false);
    const [exportRevealDialogOpen, setExportRevealDialogOpen] = useState(false);
    const [presentationURLDialogOpen, setPresentationURLDialogOpen] =
        useState(false);
    ...
    const [mobileSubmenuAnchorEl, setMobileSubmenuAnchorEl] = useState<{
    ...
    const handleSubmenuOpen =
        (menuKey: string) => (event: React.MouseEvent<HTMLElement>) => {
            setMobileSubmenuAnchorEl((prev) => ({
                ...prev,
        ...
        <AppBar position="static" style={{ padding: "0 1%" }}>
            ...
            >
                ...
                <Box sx={{ display: { xs: "none", md: "flex" } }}>
                    ...
                    >
                        <MenuItem onClick={handleNewClick}>
                            New{" "}
                        ...
                        <MenuItem onClick={handleOpenFileClick}>
                            Open{" "}
                            <KeyboardArrowRightIcon
                                style={{ marginLeft: "auto" }}
                            />
                        ...
                        <Menu
                            id="open-menu"
                            anchorEl={anchorElOpenFile}
                            open={Boolean(anchorElOpenFile)}
                        ...
                        >
                            ...
                            <MenuItem
                                onClick={() => {
                                    setPresentationURLDialogOpen(true);
                                    handleOpenFileClose();
                                }}
                            >
                                From URL
                        ...
                        <MenuItem onClick={handleStylesClick}>
                            Import style{" "}
                            <KeyboardArrowRightIcon
                                style={{ marginLeft: "auto" }}
                            />
                        ...
                        >
                            <MenuItem onClick={handleStylesImportClick}>
                                From file
                            </MenuItem>
                            <MenuItem onClick={handleStylesImportURLClick}>
                                From URL
                            </MenuItem>
                        </Menu>
                        ...
                        >
                            ...
                            <MenuItem
                                onClick={() => {
                                    handleExportClose();
                                    handleOpenCustomExport();
                                }}
                            >
                                Export to plain HTML
                            </MenuItem>
                            <MenuItem onClick={exportCss}>
                                Export styles
                            </MenuItem>
                        </Menu>
                    </Menu>
                    ...
                    <Button color="inherit" onClick={openLanes}>
                        Lanes
                    </Button>
                    <Button color="inherit" onClick={openMetadata}>
                        Metadata
                    </Button>
                    <Button color="inherit" onClick={openConstraints}>
                        Constraints
                    </Button>
                    <Button color="inherit" onClick={openImages}>
                        Images
                    </Button>
                </Box>
            ...
            >
                ...
                >
                    ...
                    <MenuItem onClick={handleSubmenuOpen("style")}>
                        Import style{" "}
                        <KeyboardArrowLeftIcon style={{ marginLeft: "auto" }} />
                    </MenuItem>
                    <Menu
                        anchorEl={mobileSubmenuAnchorEl.style}
                        open={Boolean(mobileSubmenuAnchorEl.style)}
                        onClose={() => handleSubmenuClose("style")}
                        anchorOrigin={{ vertical: "top", horizontal: "left" }}
                        transformOrigin={{
                            vertical: "top",
                            horizontal: "right",
                    ...
                    <MenuItem onClick={handleSubmenuOpen("export")}>
                        Export
                    ...
                    <Menu
                        anchorEl={mobileSubmenuAnchorEl.export}
                        open={Boolean(mobileSubmenuAnchorEl.export)}
                        onClose={() => handleSubmenuClose("export")}
                        anchorOrigin={{ vertical: "top", horizontal: "left" }}
                        transformOrigin={{
                            vertical: "top",
                            horizontal: "right",
                ...
                <Menu
                    anchorEl={mobileSubmenuAnchorEl.view}
                    open={Boolean(mobileSubmenuAnchorEl.view)}
                    onClose={() => handleSubmenuClose("view")}
                    anchorOrigin={{ vertical: "top", horizontal: "left" }}
                    transformOrigin={{ vertical: "top", horizontal: "right" }}
                >
                    <MenuItem
            ...
            <MetadataDialog
                dialogOpen={metadataDialogOpen}
                setDialogOpen={setMetadataDialogOpen}
                metadata={metadata}
                setMetadata={setMetadata}
            />
            <ConstraintsDialog
                dialogOpen={constraintsDialogOpen}
                setDialogOpen={setConstraintsDialogOpen}
                constraints={constraints}
                setConstraints={setConstraints}
            />
            <LaneDialog
                lanes={lanes}
                dialogOpen={lanesDialogOpen}
                setDialogOpen={setLanesDialogOpen}
                setLanes={setLanes}
                addLane={addLane}
            ...
            />
            <StyleURLDialog
                dialogOpen={styleURLDialogOpen}
                setDialogOpen={setStyleURLDialogOpen}
                setStyle={setStyle}
            />
            <CustomExportDialog
                open={customExportOpen}
                onClose={handleCloseCustomExport}
                onExport={exportPresentationAsHtml}
            />
            <ImportPresentationURLDialog
                dialogOpen={presentationURLDialogOpen}
                setDialogOpen={setPresentationURLDialogOpen}
                importPresentation={importPresentation}
            />
            <SaveToURLDialog
                open={saveDialogOpen}
                onClose={() => setSaveDialogOpen(false)}
                savePresentation={exportPresentationToURL}
            />
            <RevealExportDialog
                lanes={lanes}
                open={exportRevealDialogOpen}
                onClose={handleCloseRevealExport}
