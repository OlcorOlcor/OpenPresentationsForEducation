...
test("table row mix", () => {
    ...
    visitor.visitTableRowNode(row);
    expect(visitor.getResult()).toEqual(
        "<tr><th>first</th><td>second</td></tr>",
    );
});
...
test("table", () => {
    ...
    expect(visitor.getResult()).toEqual(
        "<table><tr><th>11</th><th>12</th></tr><tr><td>21</td><td>22</td></tr></table>",
    );
});
...
test("nested list", () => {
    ...
    expect(visitor.getResult()).toEqual(
        "<ol><li>item3</li><ul><li>item1</li><li>item2</li></ul></ol>",
    );
});
...
test("section", () => {
    ...
    expect(visitor.getResult()).toEqual(
        "<div data-name=value><p>text</p></div>",
    );
});
...
test("lane", () => {
    ...
    expect(visitor.getResult()).toEqual(
        "<div data-lane=lane><div><p>text</p></div></div>",
    );
});
...
test("blockquote metadata", () => {
    ...
    visitor.visitBlockQuoteNode(blockquote);
    expect(visitor.getResult()).toEqual(
        "<blockquote data-meta=data><p>text</p></blockquote>",
    );
});
...
test("section", () => {
    ...
    visitor.visitSectionNode(section);
    expect(visitor.getResult()).toEqual(
        "<div data-name=value data-meta=data><p>text</p></div>",
    );
});
...
test("ordered list metadata", () => {
    ...
    visitor.visitListNode(list);
    expect(visitor.getResult()).toEqual(
        "<ol data-meta=data><li>item1</li><li>item2</li></ol>",
    );
});
...
test("unordered list metadata", () => {
    ...
    visitor.visitListNode(list);
    expect(visitor.getResult()).toEqual(
        "<ul data-meta=data><li>item1</li><li>item2</li></ul>",
    );
});
...
test("table metadata", () => {
    ...
    expect(visitor.getResult()).toEqual(
        "<table data-meta=data><tr><th>11</th><th>12</th></tr><tr><td>21</td><td>22</td></tr></table>",
    );
});
